...
<body class="dashboard-page">
            ...
            <form action="${pageContext.request.contextPath}/ImageUploadServlet" method="post" enctype="multipart/form-data" id="pfpForm">
                ...
                <div class="profile-header">
                     <div class="profile-avatar-container">
                        <label for="imageFile">
                            <img src="${pageContext.request.contextPath}/${not empty staff.hep_staff_image_path ? staff.hep_staff_image_path : 'images/user.jpg'}" 
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const formInputs = document.querySelectorAll('#accountForm input[name="staff_name"], #accountForm input[name="staff_email"], #accountForm input[name="staff_phone"], #accountForm input[name="staff_password"]');
            let originalValues = {};
